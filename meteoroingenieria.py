...
st.markdown("""
    ...
    /* Estilo específico para los módulos del inicio en negro */
    .modulo-inicio { 
...
if menu == "Inicio":
    ...
    # Subtítulos de servicios core en letra negra
    st.markdown("""
    <h3 class="modulo-inicio">• Minería de Datos</h3>
    <h3 class="modulo-inicio">• Aprendizaje Desarrollo Software con IA</h3>
    <h3 class="modulo-inicio">• Optimización de Flota</h3>
    <h3 class="modulo-inicio">• Casos de Análisis</h3>
    """, unsafe_allow_html=True)
    ...
    with col_info:
        ...
        ws_link = "https://wa.me/573122204688?text=Hola%20Meteoro-ingenieria"
