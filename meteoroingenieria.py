...
if menu == "Inicio":
    ...
    servicios = [
        {"id": 1, "t": "Estructura de Costos", "d": "Definición de costos críticos en maquinaria industrial."},
        {"id": 2, "t": "Clasificación de Costos", "d": "Categorización técnica para minería efectiva."},
        {"id": 3, "t": "Indicadores de Mantenimiento", "d": "Desarrollo de KPIs (depreciación, repuestos, mano de obra)."},
        {"id": 4, "t": "Cálculo de Costo Ideal", "d": "Modelado basado en el entorno industrial específico."},
        {"id": 5, "t": "Controles Innovadores", "d": "Implementación de sistemas de control técnico."},
        {"id": 6, "t": "Entrega de Gestión", "d": "Estudio final para toma de decisiones estratégicas."}
    ]
