...
def mostrar_metodologia():
    ...
    st.markdown("---")
    st.info("Este flujo asegura que la salud de sus datos y la realidad de los mismos, para tomar decisiones administrativas y financieras con impacto y resultados medibles.")
